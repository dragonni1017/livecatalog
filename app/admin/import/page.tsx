      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="mb-6 rounded-lg bg-white border border-gray-200 px-5 py-4 flex items-center justify-between">
          ...
          <a
            href="/template.xlsx"
            download
            className="flex items-center gap-2 rounded-lg border border-indigo-200 bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-100 transition-colors flex-shrink-0 ml-4"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
