...
export default async function BestSellersPage() {
  ...
  const [{ data: categories }, { data: viewEvents }] = await Promise.all([
  ...
  // Aggregate view counts in JS and take the top 40 IDs
    ...
    <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">Most viewed products in the last 30 days</p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 bg-white py-16 text-center">
            <p className="text-sm text-gray-500">No best-seller data yet.</p>
          </div>
        ) : (
          <>
            <div className="mb-4">
