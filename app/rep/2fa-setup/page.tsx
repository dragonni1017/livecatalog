export default function RepTwoFASetupPage() {
  const secret = process.env.REP_TOTP_SECRET
        ...
        <div className="max-w-2xl mx-auto px-4 py-10">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
            ...
            <p className="text-sm text-gray-500 mb-6">
              2FA is not currently enabled for rep accounts. Follow the steps below to enable it.
            </p>
            ...
            <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-4 text-sm text-amber-800 space-y-3 mb-6">
              ...
              <p className="font-semibold mt-2">Step 2 — Add locally and to Vercel</p>
              <p>
                Add <code className="font-mono text-xs">REP_TOTP_SECRET=&lt;your-generated-secret&gt;</code>{' '}
                to <code className="font-mono text-xs">.env.local</code>, and in your{' '}
                <a
                ...
                {' '}add the same environment variable for production.
              </p>
              ...
              <p>
                ...
                2FA on your authenticator app. Every rep account shares this same secret/QR — each
                rep scans the same code into their own authenticator app.
              </p>
            </div>
          </div>
        </div>
  ...
  const otpauthUri = `otpauth://totp/LY-USA-Rep?secret=${encodeURIComponent(secret)}&issuer=LYUSACatalog`
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          ...
          <div className="mt-8 rounded-lg bg-blue-50 border border-blue-200 px-4 py-3 text-sm text-blue-700">
            <strong>Adding a new rep?</strong> They scan this same QR code into their own
            authenticator app — the secret is shared across all rep accounts, same as{' '}
            <code className="font-mono text-xs">ADMIN_TOTP_SECRET</code> is for admins.
          </div>
        </div>
      </div>
    </div>
