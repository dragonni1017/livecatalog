...
- [project-woo-category-assignment-fix](project-woo-category-assignment-fix.md) — 2026-08-10: WooCommerce had 0 products in any category (all Uncategorized); backfilled 2,869 via Erply groupName; homepage grid partially fixed (4 tiles); nav menu + duplicate promo blocks still have 27 broken category links, deferred
