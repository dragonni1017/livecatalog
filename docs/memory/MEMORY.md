...
- [project-rep-price-tier-and-qbwc-plan](project-rep-price-tier-and-qbwc-plan.md) — 2026-08-20: reps now shop the regular storefront w/ a header tier dropdown (old /rep/order tool deleted), verified incl. a real order via /cart; QBWC (schema/qbXML/SOAP/.qwc) all DONE, only env vars + hardware remain -- full plan at C:\Users\Dragon\.claude\plans\synthetic-greeting-blum.md
