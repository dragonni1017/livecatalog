...
- [project-woo-price-integration-markup-bug](project-woo-price-integration-markup-bug.md) — UPDATED 2026-08-14 (4 passes + 2 live tests): RestApiCache trait live-tested/ruled out; Wholesale-plugin deactivate test BLOCKED by Claude Code's own permission classifier (plugin never toggled, site unchanged) — Dragon looping in other devs before retrying, don't re-attempt unprompted
