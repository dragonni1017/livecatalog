...
- [project-bin-capacity-type-grouping](project-bin-capacity-type-grouping.md) — 2026-09-14: 518 bins seeded from Erply, 461 grouped into 5 bin_types by shelf level (matches warehouse map exactly) via assign-bin-types-by-level.mjs; ALL dimensions still null — capacity unusable until measured via /admin/bins; 57 non-grid bins (receiving/shipping/combined-aisle) left unassigned, needs human review
