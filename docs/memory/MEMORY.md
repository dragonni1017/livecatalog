...
- [project-receiving-phase-1](project-receiving-phase-1.md) — 2026-09-16: /admin/receiving (packing list → staged counts → Erply stock, once) built; migration 0048 applied + table layer verified; apply still blocked wherever Erply creds are absent (incl. Vercel prod); parser port verified against the real EMCU8402359 workbook
