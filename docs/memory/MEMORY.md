...
- [project-net-terms-approval-flow](project-net-terms-approval-flow.md) — 2026-09-15: /admin/credit-applications can now approve/decline; migration 0047 NOT YET APPLIED (4 real buyers stuck at pending) and the decision feeds nothing downstream
