...
- [project-receiving-to-catalog-20260923](project-receiving-to-catalog-20260923.md) — 2026-09-23: five containers received (75 new Erply SKUs, stock verified); the Erply sync could NOT insert them (products_id_seq collides with hand-assigned prod-NNNNN ids, whole 500-row chunks fail — migration 0052 reseeds it, NOT YET APPLIED); all 75 pushed into the catalog hidden at $0 (a visible $0 product is orderable), 52 with photos; admin "Sync Now" was missing the category alias/skip the cron has
