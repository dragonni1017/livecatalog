...
- [project-rep-price-tier-and-qbwc-plan](project-rep-price-tier-and-qbwc-plan.md) — 2026-08-20/21: rep-tier % bug fixed+verified; QBWC hardware-tested and working (4/4 acked); 2026-08-21 added ship-to address (was missing entirely) + fixed a real PONumber-after-Memo qbXML ordering bug, both verified live -- plan at C:\Users\Dragon\.claude\plans\synthetic-greeting-blum.md
