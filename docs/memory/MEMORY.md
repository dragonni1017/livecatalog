...
- [project-fake-stock-1000-hold](project-fake-stock-1000-hold.md) — 2026-09-16: 1,879 of 3,225 products still read stock_qty exactly 1000 (the Aug connectivity-test value); Dragon's call is DO NOT adjust yet — receiving adds on top of it, so confirm before the first real apply
