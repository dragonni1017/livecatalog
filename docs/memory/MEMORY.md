...
- [project-rep-price-tier-and-qbwc-plan](project-rep-price-tier-and-qbwc-plan.md) — 2026-08-20: rep price-tier ordering DONE, real rep account sale@ly-usa.com live w/ working 2FA; QBWC (schema/qbXML/SOAP endpoint/.qwc generator) all DONE + verified, only env vars + real hardware remain -- full plan at C:\Users\Dragon\.claude\plans\synthetic-greeting-blum.md
