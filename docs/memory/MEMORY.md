...
- [project-receiving-phase-1](project-receiving-phase-1.md) — 2026-09-16: /admin/receiving (packing list → staged counts → Erply stock, once) built; Phase 1 (stock) + Phase 2 (new products from the Commercial Invoice); 0048 applied, 0049 NOT applied; saveProduct never yet called; real 2026 files use 总PCS not QTY
