...
- [project-suffix-barcode-collisions](project-suffix-barcode-collisions.md) — 2026-09-17: 52 suffixed SKUs carry their base SKU's barcode; 51 hidden + never ordered, F286411-M is the only VISIBLE pair and the only live scanning hazard
