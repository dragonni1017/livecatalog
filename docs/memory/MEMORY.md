...
- [project-f287569-erply-orphan-barcode-anomaly](project-f287569-erply-orphan-barcode-anomaly.md) — 2026-08-19: F287569 doesn't exist in Erply under any identifier; its Supabase barcode belongs to unrelated Erply product D701113 -- needs physical/supplier check, not more digging
