...
- [project-packing-list-importer](project-packing-list-importer.md) — 2026-09-14: scripts/import-packing-list.mjs writes real supplier carton measurements from OneDrive "*Original List*.xls" shipment files (SKU+UPC verified, units read from header text); confirmed working live on container EMCU8402359 (27/27 written, 0 rejected); only that filename pattern is validated — the PDF-only shipment docs in the same folder have no SKU column and aren't handled
